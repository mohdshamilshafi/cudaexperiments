...
\section{Test Data}
We obtained most of our test datasets from Stanford Network Analysis Project (SNAP) \citep{snapnets}. We also use the 30 graph colouring datasets from \citet{Beasley1990} which are very small graphs and also appear in Table 6 of the paper \citetitle{ref1}. 
